...
class FlickrClient {
    ...
    func bboxString(latitude: Double, longitude: Double) -> String {
        ...
        let minimumLon = max(longitude - FlickrClient.Constants.SearchBBoxHalfWidth, FlickerClient.Constants.SearchLonRange.0)
        let minimumLat = max(latitude  - FlickrClient.Constants.SearchBBoxHalfHeight, FlickerClient.Constants.SearchLatRange.0)
        let maximumLon = min(longitude + FlickrClient.Constants.SearchBBoxHalfWidth, FlickerClient.Constants.SearchLonRange.1)
        let maximumLat = min(latitude  + FlickrClient.Constants.SearchBBoxHalfHeight, FlickerClient.Constants.SearchLatRange.1)
